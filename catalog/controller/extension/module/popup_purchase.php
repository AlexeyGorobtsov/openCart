...
class ControllerExtensionModulePopupPurchase extends Controller {
    ...
    $data['popup_purchase_data'] = $popup_purchase_data;
      ...
      $data['mask'] = ($popup_purchase_data['mask']) ? $popup_purchase_data['mask'] : '';
      ...
      $this->response->setOutput($this->load->view('extension/module/popup_purchase', $data));
		} else {
  ...
  public function make_order() {
      ...
      $this->language->load('extension/module/popup_purchase');
      $this->load->model('catalog/product');
